                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="http://teachme.app/auth/logout">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h2 class="title-show">
                Magnanimus impedit voluptatibus architecto quidem iste eum ut.
            ...
            <form method="POST" action="http://teachme.app/votar/5" accept-charset="UTF-8"><input name="_token" type="hidden" value="VBIv3EWDAIQuLRW0cGwNQ4OsDKoRhnK2fAEF6UbQ">
            ...
            <form method="POST" action="http://teachme.app/comentar/5" accept-charset="UTF-8"><input name="_token" type="hidden" value="VBIv3EWDAIQuLRW0cGwNQ4OsDKoRhnK2fAEF6UbQ">
